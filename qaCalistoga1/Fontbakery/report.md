...
<details>
<summary><b>[6] Calistoga-Regular.ttf</b></summary>
<details>
...
"Copyright (c) 2018, Sorkin Type Co (www.sorkintype.com) with Reserved Font Name 'Calistoga'." [code: bad-notice-format]
* 🔥 **FAIL** Name Table entry: Copyright notices should match a pattern similar to: "Copyright 2019 The Familyname Project Authors (git url)"
But instead we have got:
"Copyright (c) 2018, Sorkin Type Co (www.sorkintype.com) with Reserved Font Name 'Calistoga'." [code: bad-notice-format]
...
* ⚠ **WARN** Name table entry ("Copyright (c) 2018, Sorkin Type Co (www.sorkintype.com) with Reserved Font Name 'Calistoga'.") contains "Reserved Font Name". This is an error except in a few specific rare cases.
* ⚠ **WARN** Name table entry ("Copyright (c) 2018, Sorkin Type Co (www.sorkintype.com) with Reserved Font Name 'Calistoga'.") contains "Reserved Font Name". This is an error except in a few specific rare cases.
